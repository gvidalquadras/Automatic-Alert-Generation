...
from ner import NERDataset, NERModel, collate_fn, load_ner_data
from train_NER import evaluate_model
import fasttext
...
def main():
    ...
    model.load_state_dict(torch.load("models/ner_model2.pth"))
